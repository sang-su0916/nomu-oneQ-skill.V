...
| **capital-gains-tax**             | 양도소득세 (부동산 5모드 — 차익·장특공·비과세·세액·종합)                |
| **year-end-settlement**           | 연말정산 (2026 귀속 간이 계산 + 변경사항)                               |
| **inheritance-gift-tax**          | 상속세·증여세 (5단계 누진, 배우자·일괄·증여재산·혼인출산공제 통합)      |
| **acquisition-tax**               | 취득세 (유상 주택 1~3%, 법인·다주택 중과 8~12%, 농특세·지방교육세 포함) |
| **comprehensive-real-estate-tax** | 종합부동산세 (1세대1주택 12억 / 일반 9억 공제, 공정시장가액비율 60%)    |
...
| **shareholder-meeting-minutes** | 주주총회의사록 — 결의정족수 판정·소집통지 마감·§373 필수기재사항 체크 |
