  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text)]">사직서</h1>
        ...
        <div className="flex gap-2">
          ...
          {showPreview && (
            <EmailSendButton
              documentTitle={`사직서 — ${data.employeeName || "미입력"}`}
              documentType="사직서"
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setData((prev) => ({ ...prev, submitDate: e.target.value }))
                  }
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  className="input-field"
                  rows={3}
                  placeholder="구체적인 사직 사유를 입력하세요 (선택사항)"
          ...
          <div className="alert alert-warning">
            <div className="text-sm">
              ...
              <p className="opacity-80 mt-1">
                근로기준법 제26조에 따라 근로자가 해고되는 경우 30일 전에
                예고해야 합니다. 근로자의 자발적 사직의 경우에도 원활한 업무
                인수인계를 위해 최소 30일 전 제출을 권장합니다.
              </p>
            </div>
          </div>
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg mt-3">
            ...
            <ul className="text-xs text-blue-700 mt-1 space-y-0.5 list-disc list-inside">
              <li>
                <strong>수리 전</strong>: 사직 의사를 철회할 수 있습니다 (대법원
                2000다51919)
              </li>
              <li>
                <strong>수리 후</strong>: 합의해지가 성립하여 일방적 철회가
                불가합니다
              </li>
              <li>
                사용자가 사직서를 수리하지 않더라도, 민법 제660조에 따라 해지
                통고 후 1개월이 경과하면 퇴직 효력이 발생합니다 (월급제 기준)
              </li>
            </ul>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "15px", marginBottom: "32px", lineHeight: 2 }}>
        본인은 아래와 같은 사유로 <strong>{formatDate(data.resignDate)}</strong>
      ...
      >
        <table style={{ width: "100%" }}>
          <tbody>
            <tr>
              <td style={{ padding: "8px 0", color: "#555", width: "80px" }}>
                사직자
              </td>
              <td
