...
const SKILLS = [
  ...
  },
  {
    ...
    emoji: "🏛️",
    title: "상속세·증여세",
    subtitle: "5단계 누진, 배우자·일괄·증여재산·혼인출산공제 통합",
    description:
      "상증세법 §18/§19/§21/§26/§53/§53의2 기준. 상속세(기초2억·배우자·일괄5억)·증여세(배우자6억/직계5천/미성년2천) 공제 → 5단계 누진세율(10~50%) → 산출세액. 혼인·출산공제 합산 1억 한도 자동 적용. 상속 vs 증여 유불리 비교 지원.",
    triggers: [
      "상속세",
      "증여세",
      "상속공제",
    ...
    triggerExample: "아버지 재산 15억, 배우자·자녀 2명 상속 시 상속세 얼마?",
    resultExample:
      "일괄공제 5억 + 배우자공제 적용 후 과세표준 산출 → 세율 30% 구간 → 산출세액 약 1.5억",
    source: "상증세법 §18·§19·§21·§26·§53·§53의2",
    accentColor: "#f5f3ff",
    accentText: "#4c1d95",
  },
  {
    ...
    emoji: "🏠",
    title: "취득세",
    subtitle: "유상 주택 1~3%, 법인·다주택 중과 8~12%, 부가세 포함",
    description:
      "지방세법 §11·§13의2 기준. 유상 주택 3구간(6억↓ 1%/6~9억 공식세율/9억↑ 3%), 1세대 다주택 중과(8%/12%), 법인 12%, 증여 3.5%/조정지역 12%. 농어촌특별세·지방교육세 부가세 동시 산출.",
    triggers: [
      "취득세",
      "다주택 중과",
      "법인 취득",
    ...
    triggerExample:
      "9억 5천 아파트 1세대2주택(조정지역) 취득 시 취득세 총부담?",
    resultExample:
      "중과세율 8% × 9.5억 = 7,600만 + 농특세 760만 + 지방교육세 760만 = 총 9,120만",
    source: "지방세법 §11·§13의2, 농어촌특별세법 §5, 지방세법 §151",
    accentColor: "#fff7ed",
    accentText: "#7c2d12",
  },
  {
    ...
    emoji: "🏢",
    title: "종합부동산세",
    subtitle: "1세대1주택 12억 / 일반 9억 공제, 공정시장가액비율 60%",
    description:
      "종부세법 §8/§9 기준. 공시가격 합산 → 공제(1세대1주택 12억/일반 9억/법인 0) → 공정시장가액비율 60%(시행령 현재값) → 2주택 이하/3주택 이상 차등 세율 → 고령자·장기보유 세액공제(합산 80% 한도).",
    triggers: [
      "종부세",
      "종합부동산세",
      "공정시장가액비율",
    ...
    triggerExample: "공시가 8억+6억 주택 2채 보유, 일반과세자 종부세 얼마?",
    resultExample:
      "(14억 − 9억) × 60% = 3억 과세표준 → 세율 1.0% → 산출세액 300만",
    source: "종부세법 §8·§9, 시행령 §2의4",
    accentColor: "#ecfeff",
    accentText: "#164e63",
  },
  {
