...
| **inheritance-gift-tax**          | 상속세·증여세 (5단계 누진, 배우자·일괄·증여재산·혼인출산공제)        | 상속세, 증여세, 상속공제, 배우자공제, 일괄공제, 혼인공제, 출산공제, 증여재산공제, 상속 vs 증여 |
| **acquisition-tax**               | 취득세 (유상 주택 1~3%, 법인·다주택 중과, 농특세·지방교육세)         | 취득세, 다주택 중과, 법인 취득, 농어촌특별세, 지방교육세, 주택 취득                            |
| **comprehensive-real-estate-tax** | 종합부동산세 (1세대1주택 12억 / 일반 9억 공제, 공정시장가액비율 60%) | 종부세, 종합부동산세, 공정시장가액비율, 1세대1주택, 고령자공제, 장기보유공제                   |
...
| **shareholder-meeting-minutes** | 보통결의·특별결의 정족수 판정, 소집통지 마감 계산, §373 필수기재사항 체크, 정기주총 안건 7종 템플릿 | 주주총회, 의사록, 결의정족수, 보통결의, 특별결의, 소집통지 |

OMSC로 추가 예정: 등록세, 공증료, 임대보증금 반환, 상속분 산정.
